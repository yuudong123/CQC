...
- 상세 검토: [`[DM-03] 그룹 층화 분할·교차검증.md`](./wbs/%5BDM-03%5D%20그룹%20층화%20분할·교차검증.md)
...
실행 결과와 중복 식별자는 [`[DM-02] 그룹 EDA·품질 검사.md`](./wbs/%5BDM-02%5D%20그룹%20EDA·품질%20검사.md)에 기록한다.
...
전체 179그룹 검증에서 4·8장은 패딩이 없고, 12·16장은 8장 그룹 하나만 각각 4·8슬롯을 패딩한다. 40장은 8·16·21·30장 그룹 네 개에 총 85슬롯을 패딩한다. 상세 결과는 [`[DM-04] 다각도 로더·누락 뷰 마스킹.md`](./wbs/%5BDM-04%5D%20다각도%20로더·누락%20뷰%20마스킹.md)와 `configs/view-selection-summary.json`에 기록한다.
